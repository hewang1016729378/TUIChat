...
//    } else if ([TUIConfig defaultConfig].avatarType == TAvatarTypeRadiusCorner) {
        self.avatarView.layer.masksToBounds = YES;
    self.avatarView.layer.cornerRadius = 18.0f; //[TUIConfig defaultConfig].avatarCornerRadius;
//    }
...
- (void)layoutSubviews
{
    ...
    if (self.messageData.direction == MsgDirectionIncoming) {
        ...
        self.avatarView.mm_w = 36; //cellLayout.avatarSize.width;
        self.avatarView.mm_h = 36; //cellLayout.avatarSize.height;
