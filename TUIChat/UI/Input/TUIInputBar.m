...
//    [self addSubview:_recordButton];
    ...
    _labelPlaceHolder.text = @"请输入聊天内容…";
    _labelPlaceHolder.textColor = HEXRGBCOLOR(0xB2B2B2);
    _labelPlaceHolder.font = [UIFont systemFontOfSize:15];
    [_inputTextView addSubview:_labelPlaceHolder];
...
//    CGFloat endX = _faceButton.frame.origin.x - 16;
//    _recordButton.frame = CGRectMake(beginX, (TTextView_Height - TTextView_TextView_Height_Min) * 0.5, endX - beginX, TTextView_TextView_Height_Min);
    _inputTextView.frame = CGRectMake(x, (TTextView_Height - TTextView_TextView_Height_Min) * 0.5, Screen_Width - x * 2 - 40, TTextView_TextView_Height_Min);
    _labelPlaceHolder.frame = CGRectMake(5, 0, 140, TTextView_TextView_Height_Min);
    _faceButton.frame = CGRectMake(CGRectGetMaxX(_inputTextView.frame) + 5, buttonOriginY, 45, _inputTextView.frame.size.height - TTextView_Margin);
}
